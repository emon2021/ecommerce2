                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image" style="height: 200px; overflow:hidden;">
                                                <a href="{{route('single.product',$featured->slug)}}">
                                                    <img src="{{asset($featured->thumbnail)}}" style="height: 100%; background-size:cover;" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="{{route('single.product',$featured->slug)}}">Graphic Corner</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="{{route('single.product',$featured->slug)}}">{{$featured->name}}</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price"> 
                                                            @if($featured->discount_price)
                                                                <span style="text-decoration: line-through;color:black">{{$setting->currency}} {{$featured->selling_price}}</span>
                                                                <span style="color: darkred">{{$setting->currency}} {{$featured->discount_price}}</span>
                                                            @else
                                                                <span>{{$setting->currency}} {{$featured->selling_price}}</span>
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="single-product-wrap">
                                    ...
                                    <div class="product_desc">
                                        <div class="product_desc_info">
                                            <div class="product-review">
                                                <h5 class="manufacturer">
                                                    <a href="{{route('single.product',$hotDeal->slug)}}">Graphic Corner</a>
                                                </h5>
                                                <div class="rating-box">
                                                    <ul class="rating">
                                                        <li><i class="fa fa-star-o"></i></li>
                                            ...
                                            <h4><a class="product_name" href="{{route('single.product',$hotDeal->slug)}}">{{$hotDeal->name}}</a></h4>
                                            <div class="price-box">
                                                <span class="new-price">
                                                    @if($hotDeal->discount_price)
                                                                <span style="text-decoration: line-through;color:black">{{$setting->currency}} {{$hotDeal->selling_price}}</span>
                                                                <span style="color: darkred">{{$setting->currency}} {{$hotDeal->discount_price}}</span>
                                                            @else
                                                                <span>{{$setting->currency}} {{$hotDeal->selling_price}}</span>
                                                            @endif
                                                </span>
                                            </div>
                                        ...
                                        <div class="add-actions">
                                            <ul class="add-actions-link">
                                                <li class="add-cart active"><a href="#">Add to cart</a></li>
                                                @php
                                                            $hot_wishlist = DB::table('wishlists')->where('user_id', Auth::id())->where('product_id',$hotDeal->id)->first();
                                                        @endphp
                                                        <li><a class="links-details wishlist-btn  wishlist_add" href="{{route('product.wishlist',$hotDeal->id)}}" >
                                                            @if($hot_wishlist)
                                                            <i class="fa fa-heart"></i>
                                                           @else
                                                            <i class="fa fa-heart feature d-none"></i>
                                                ...
                                                <li><a href="{{route('quick.view',$hotDeal->id)}}" title="quick view" class="quick-view-btn quickView" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="li-banner-2 pt-15">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('public/frontend')}}/images/banner/2_3.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
                ...
                <div class="li-banner-2 pt-15">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('public/frontend')}}/images/banner/2_5.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-banner pt-xs-30">
                                <a href="#">
                                    <img src="{{asset('public/frontend')}}/images/banner/2_6.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image" style="height: 210px">
                                                <a href="{{route('single.product',$trendy->slug)}}">
                                                    <img src="{{asset($trendy->thumbnail)}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="{{route('single.product',$trendy->slug)}}">Graphic Corner</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="{{route('single.product',$trendy->slug)}}">{{$trendy->name}}</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">
                                                            @if($trendy->discount_price)
                                                                <span style="text-decoration: line-through;color:black">{{$setting->currency}} {{$trendy->selling_price}}</span>
                                                                <span style="color: darkred">{{$setting->currency}} {{$trendy->discount_price}}</span>
                                                            @else
                                                                <span>{{$setting->currency}} {{$trendy->selling_price}}</span>
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="#">Add to cart</a></li>
                                                        @php
                                                            $trendy_wishlist = DB::table('wishlists')->where('user_id', Auth::id())->where('product_id',$trendy->id)->first();
                                                        @endphp
                                                        <li><a class="links-details wishlist-btn  wishlist_add" href="{{route('product.wishlist',$trendy->id)}}" >
                                                            @if($trendy_wishlist)
                                                            <i class="fa fa-heart"></i>
                                                        @else
                                                            <i class="fa fa-heart feature d-none"></i>
                                                        ...
                                                        <li><a href="{{route('quick.view',$trendy->id)}}" title="quick view" class="quick-view-btn quickView" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
            ...
            $('.quickView').click(function(e){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        $('.modal_body_wrapper').html(response);   //  response from server in html
                    }
                });
            });
        });
