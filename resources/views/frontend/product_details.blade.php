...
@section('content')
@push('title')
    <title>Product Details || Single Product</title>
@endpush
                    ...
                    <div class="product-info">
                        ...
                        <div class="price-box pt-20" style="margin: 40px 0px 0px 10px">
                            <span style="font-size: 20px">Price:</span>
                                ...
                                <span class="new-price new-price-2" @if($single_product->discount_price != null) style="text-decoration: line-through; font-size:18px" @endif> {{$setting->currency}} {{$single_product->selling_price}}</span>
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <div class="price-box">
                                            ...
                                            <span class="new-price" style="">{{$setting->currency}} {{$related->discount_price}}</span>
                                           @else
                                           <span class="new-price">{{$setting->currency}} {{$related->selling_price}}</span>
                                           @endif
                                        </div>
                                    </div>
